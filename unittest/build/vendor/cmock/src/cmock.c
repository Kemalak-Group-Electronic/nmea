...
CMock_Guts_MemNew(CMOCK_MEM_INDEX_TYPE size)
{
 ...
 *-------------------------------------------------------*/
CMOCK_MEM_INDEX_TYPE
CMock_Guts_MemChain(CMOCK_MEM_INDEX_TYPE root_index,
 ...
 *-------------------------------------------------------*/
CMOCK_MEM_INDEX_TYPE
CMock_Guts_MemEndOfChain(CMOCK_MEM_INDEX_TYPE root_index)
{
 ...
 *-------------------------------------------------------*/
void *
CMock_Guts_GetAddressFor (CMOCK_MEM_INDEX_TYPE index)
{
 ...
 *-------------------------------------------------------*/
CMOCK_MEM_INDEX_TYPE
CMock_Guts_MemBytesCapacity(void)
{
